...
from edgs.gaussian_splatting.graphics_utils import getWorld2View2, getProjectionMatrix
...
class Camera(nn.Module):
    def __init__(
        ...
        if resized_image_rgb.shape[0] == 4:
            ...
            # This is just wasting memory as it's not used by EDGS so we will not set the alpha mask to all ones.
